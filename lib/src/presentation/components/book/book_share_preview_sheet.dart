...
class BookSharePreviewSheet extends ConsumerStatefulWidget {
  ...
  ConsumerState<BookSharePreviewSheet> createState() =>
      _BookSharePreviewSheetState();
}

class _BookSharePreviewSheetState extends ConsumerState<BookSharePreviewSheet> {
  ...
  void didChangeDependencies() {
    ...
    if (_messageController.text.isEmpty) {
      _messageController.text = generateBookShareText(
        book: widget.book,
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: l10n.defaultShareMessage(widget.book.title),
...
void showBookSharePreviewSheet({
  ...
  showModalBottomSheet(
    ...
    backgroundColor: Colors.transparent,
    builder: (context) => BookSharePreviewSheet(book: book),
  );
}
