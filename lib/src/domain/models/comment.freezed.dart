...
mixin _$Comment {
 ...
 String? get id; dynamic get bookId; String? get bookTitle; String get userId; String get username; String get text; int? get rating; String? get chapterTitle; int? get chapterIndex; String? get chapterId; String? get quote; int get timestamp; String? get feedPostId; String? get userPhotoURL; String? get displayName; String? get penName; List<CommentReply>? get replies; List<String>? get likes; int? get likesCount; int? get repliesCount; Map<String, String>? get mentions; bool? get isHighlighted; int? get highlightedAt; String? get highlightedByUserId; String? get audioUrl; String? get audioObjectKey; int? get audioDurationMs; String? get audioMimeType; int? get audioSizeBytes;
...
@useResult
$Res call({
 String? id, dynamic bookId, String? bookTitle, String userId, String username, String text, int? rating, String? chapterTitle, int? chapterIndex, String? chapterId, String? quote, int timestamp, String? feedPostId, String? userPhotoURL, String? displayName, String? penName, List<CommentReply>? replies, List<String>? likes, int? likesCount, int? repliesCount, Map<String, String>? mentions, bool? isHighlighted, int? highlightedAt, String? highlightedByUserId, String? audioUrl, String? audioObjectKey, int? audioDurationMs, String? audioMimeType, int? audioSizeBytes
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  dynamic bookId,  String? bookTitle,  String userId,  String username,  String text,  int? rating,  String? chapterTitle,  int? chapterIndex,  String? chapterId,  String? quote,  int timestamp,  String? feedPostId,  String? userPhotoURL,  String? displayName,  String? penName,  List<CommentReply>? replies,  List<String>? likes,  int? likesCount,  int? repliesCount,  Map<String, String>? mentions,  bool? isHighlighted,  int? highlightedAt,  String? highlightedByUserId,  String? audioUrl,  String? audioObjectKey,  int? audioDurationMs,  String? audioMimeType,  int? audioSizeBytes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Comment() when $default != null:
return $default(_that.id,_that.bookId,_that.bookTitle,_that.userId,_that.username,_that.text,_that.rating,_that.chapterTitle,_that.chapterIndex,_that.chapterId,_that.quote,_that.timestamp,_that.feedPostId,_that.userPhotoURL,_that.displayName,_that.penName,_that.replies,_that.likes,_that.likesCount,_that.repliesCount,_that.mentions,_that.isHighlighted,_that.highlightedAt,_that.highlightedByUserId,_that.audioUrl,_that.audioObjectKey,_that.audioDurationMs,_that.audioMimeType,_that.audioSizeBytes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  dynamic bookId,  String? bookTitle,  String userId,  String username,  String text,  int? rating,  String? chapterTitle,  int? chapterIndex,  String? chapterId,  String? quote,  int timestamp,  String? feedPostId,  String? userPhotoURL,  String? displayName,  String? penName,  List<CommentReply>? replies,  List<String>? likes,  int? likesCount,  int? repliesCount,  Map<String, String>? mentions,  bool? isHighlighted,  int? highlightedAt,  String? highlightedByUserId,  String? audioUrl,  String? audioObjectKey,  int? audioDurationMs,  String? audioMimeType,  int? audioSizeBytes)  $default,) {final _that = this;
switch (_that) {
case _Comment():
return $default(_that.id,_that.bookId,_that.bookTitle,_that.userId,_that.username,_that.text,_that.rating,_that.chapterTitle,_that.chapterIndex,_that.chapterId,_that.quote,_that.timestamp,_that.feedPostId,_that.userPhotoURL,_that.displayName,_that.penName,_that.replies,_that.likes,_that.likesCount,_that.repliesCount,_that.mentions,_that.isHighlighted,_that.highlightedAt,_that.highlightedByUserId,_that.audioUrl,_that.audioObjectKey,_that.audioDurationMs,_that.audioMimeType,_that.audioSizeBytes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  dynamic bookId,  String? bookTitle,  String userId,  String username,  String text,  int? rating,  String? chapterTitle,  int? chapterIndex,  String? chapterId,  String? quote,  int timestamp,  String? feedPostId,  String? userPhotoURL,  String? displayName,  String? penName,  List<CommentReply>? replies,  List<String>? likes,  int? likesCount,  int? repliesCount,  Map<String, String>? mentions,  bool? isHighlighted,  int? highlightedAt,  String? highlightedByUserId,  String? audioUrl,  String? audioObjectKey,  int? audioDurationMs,  String? audioMimeType,  int? audioSizeBytes)?  $default,) {final _that = this;
switch (_that) {
case _Comment() when $default != null:
return $default(_that.id,_that.bookId,_that.bookTitle,_that.userId,_that.username,_that.text,_that.rating,_that.chapterTitle,_that.chapterIndex,_that.chapterId,_that.quote,_that.timestamp,_that.feedPostId,_that.userPhotoURL,_that.displayName,_that.penName,_that.replies,_that.likes,_that.likesCount,_that.repliesCount,_that.mentions,_that.isHighlighted,_that.highlightedAt,_that.highlightedByUserId,_that.audioUrl,_that.audioObjectKey,_that.audioDurationMs,_that.audioMimeType,_that.audioSizeBytes);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Comment&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other.bookId, bookId)&&(identical(other.bookTitle, bookTitle) || other.bookTitle == bookTitle)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.username, username) || other.username == username)&&(identical(other.text, text) || other.text == text)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.chapterTitle, chapterTitle) || other.chapterTitle == chapterTitle)&&(identical(other.chapterIndex, chapterIndex) || other.chapterIndex == chapterIndex)&&(identical(other.chapterId, chapterId) || other.chapterId == chapterId)&&(identical(other.quote, quote) || other.quote == quote)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.feedPostId, feedPostId) || other.feedPostId == feedPostId)&&(identical(other.userPhotoURL, userPhotoURL) || other.userPhotoURL == userPhotoURL)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.penName, penName) || other.penName == penName)&&const DeepCollectionEquality().equals(other._replies, _replies)&&const DeepCollectionEquality().equals(other._likes, _likes)&&(identical(other.likesCount, likesCount) || other.likesCount == likesCount)&&(identical(other.repliesCount, repliesCount) || other.repliesCount == repliesCount)&&const DeepCollectionEquality().equals(other._mentions, _mentions)&&(identical(other.isHighlighted, isHighlighted) || other.isHighlighted == isHighlighted)&&(identical(other.highlightedAt, highlightedAt) || other.highlightedAt == highlightedAt)&&(identical(other.highlightedByUserId, highlightedByUserId) || other.highlightedByUserId == highlightedByUserId)&&(identical(other.audioUrl, audioUrl) || other.audioUrl == audioUrl)&&(identical(other.audioObjectKey, audioObjectKey) || other.audioObjectKey == audioObjectKey)&&(identical(other.audioDurationMs, audioDurationMs) || other.audioDurationMs == audioDurationMs)&&(identical(other.audioMimeType, audioMimeType) || other.audioMimeType == audioMimeType)&&(identical(other.audioSizeBytes, audioSizeBytes) || other.audioSizeBytes == audioSizeBytes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,const DeepCollectionEquality().hash(bookId),bookTitle,userId,username,text,rating,chapterTitle,chapterIndex,chapterId,quote,timestamp,feedPostId,userPhotoURL,displayName,penName,const DeepCollectionEquality().hash(_replies),const DeepCollectionEquality().hash(_likes),likesCount,repliesCount,const DeepCollectionEquality().hash(_mentions),isHighlighted,highlightedAt,highlightedByUserId,audioUrl,audioObjectKey,audioDurationMs,audioMimeType,audioSizeBytes]);
