...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,username,type,const DeepCollectionEquality().hash(bookId),bookTitle,bookAuthorName,bookCover,text,quote,rating,chapterTitle,chapterId,timestamp,const DeepCollectionEquality().hash(_likes),likesCount,userPhotoURL,displayName,penName,const DeepCollectionEquality().hash(_comments),targetUserId,targetUsername,targetUserDisplayName,targetUserPenName,privacy,visibility,imageUrl,const DeepCollectionEquality().hash(_images),commentCount,const DeepCollectionEquality().hash(_mentions)]);
