...
mixin _$UserModel {
 ...
 String get id; String get username; String get email; String? get displayName; String? get photoURL; String? get coverPhotoURL; String? get bio; String? get penName; String? get instagramHandle; String? get privacyLevel; bool? get isDeactivated; ProfileVisibility? get profileVisibility; int? get followersCount; int? get followingCount; List<dynamic> get readingHistory; List<dynamic> get savedBooks; List<Bookmark> get bookmarks; String? get preferredLanguage; List<String>? get pinnedWorks; int? get createdAt; int? get lastLogin; Map<String, dynamic>? get readingProgress; List<String>? get fcmTokens; NotificationSettings? get notificationSettings; int? get authorPoints; int? get authorRank; int? get readerPoints; int? get readerRank; int get booksReadCount; int get commentsPostedCount;
...
@useResult
$Res call({
 String id, String username, String email, String? displayName, String? photoURL, String? coverPhotoURL, String? bio, String? penName, String? instagramHandle, String? privacyLevel, bool? isDeactivated, ProfileVisibility? profileVisibility, int? followersCount, int? followingCount, List<dynamic> readingHistory, List<dynamic> savedBooks, List<Bookmark> bookmarks, String? preferredLanguage, List<String>? pinnedWorks, int? createdAt, int? lastLogin, Map<String, dynamic>? readingProgress, List<String>? fcmTokens, NotificationSettings? notificationSettings, int? authorPoints, int? authorRank, int? readerPoints, int? readerRank, int booksReadCount, int commentsPostedCount
});
...
/// Create a copy of UserModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? username = null,Object? email = null,Object? displayName = freezed,Object? photoURL = freezed,Object? coverPhotoURL = freezed,Object? bio = freezed,Object? penName = freezed,Object? instagramHandle = freezed,Object? privacyLevel = freezed,Object? isDeactivated = freezed,Object? profileVisibility = freezed,Object? followersCount = freezed,Object? followingCount = freezed,Object? readingHistory = null,Object? savedBooks = null,Object? bookmarks = null,Object? preferredLanguage = freezed,Object? pinnedWorks = freezed,Object? createdAt = freezed,Object? lastLogin = freezed,Object? readingProgress = freezed,Object? fcmTokens = freezed,Object? notificationSettings = freezed,Object? authorPoints = freezed,Object? authorRank = freezed,Object? readerPoints = freezed,Object? readerRank = freezed,Object? booksReadCount = null,Object? commentsPostedCount = null,}) {
  return _then(_self.copyWith(
...
as NotificationSettings?,authorPoints: freezed == authorPoints ? _self.authorPoints : authorPoints // ignore: cast_nullable_to_non_nullable
as int?,authorRank: freezed == authorRank ? _self.authorRank : authorRank // ignore: cast_nullable_to_non_nullable
as int?,readerPoints: freezed == readerPoints ? _self.readerPoints : readerPoints // ignore: cast_nullable_to_non_nullable
as int?,readerRank: freezed == readerRank ? _self.readerRank : readerRank // ignore: cast_nullable_to_non_nullable
as int?,booksReadCount: null == booksReadCount ? _self.booksReadCount : booksReadCount // ignore: cast_nullable_to_non_nullable
as int,commentsPostedCount: null == commentsPostedCount ? _self.commentsPostedCount : commentsPostedCount // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
/// Create a copy of UserModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String username,  String email,  String? displayName,  String? photoURL,  String? coverPhotoURL,  String? bio,  String? penName,  String? instagramHandle,  String? privacyLevel,  bool? isDeactivated,  ProfileVisibility? profileVisibility,  int? followersCount,  int? followingCount,  List<dynamic> readingHistory,  List<dynamic> savedBooks,  List<Bookmark> bookmarks,  String? preferredLanguage,  List<String>? pinnedWorks,  int? createdAt,  int? lastLogin,  Map<String, dynamic>? readingProgress,  List<String>? fcmTokens,  NotificationSettings? notificationSettings,  int? authorPoints,  int? authorRank,  int? readerPoints,  int? readerRank,  int booksReadCount,  int commentsPostedCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.id,_that.username,_that.email,_that.displayName,_that.photoURL,_that.coverPhotoURL,_that.bio,_that.penName,_that.instagramHandle,_that.privacyLevel,_that.isDeactivated,_that.profileVisibility,_that.followersCount,_that.followingCount,_that.readingHistory,_that.savedBooks,_that.bookmarks,_that.preferredLanguage,_that.pinnedWorks,_that.createdAt,_that.lastLogin,_that.readingProgress,_that.fcmTokens,_that.notificationSettings,_that.authorPoints,_that.authorRank,_that.readerPoints,_that.readerRank,_that.booksReadCount,_that.commentsPostedCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String username,  String email,  String? displayName,  String? photoURL,  String? coverPhotoURL,  String? bio,  String? penName,  String? instagramHandle,  String? privacyLevel,  bool? isDeactivated,  ProfileVisibility? profileVisibility,  int? followersCount,  int? followingCount,  List<dynamic> readingHistory,  List<dynamic> savedBooks,  List<Bookmark> bookmarks,  String? preferredLanguage,  List<String>? pinnedWorks,  int? createdAt,  int? lastLogin,  Map<String, dynamic>? readingProgress,  List<String>? fcmTokens,  NotificationSettings? notificationSettings,  int? authorPoints,  int? authorRank,  int? readerPoints,  int? readerRank,  int booksReadCount,  int commentsPostedCount)  $default,) {final _that = this;
switch (_that) {
case _UserModel():
return $default(_that.id,_that.username,_that.email,_that.displayName,_that.photoURL,_that.coverPhotoURL,_that.bio,_that.penName,_that.instagramHandle,_that.privacyLevel,_that.isDeactivated,_that.profileVisibility,_that.followersCount,_that.followingCount,_that.readingHistory,_that.savedBooks,_that.bookmarks,_that.preferredLanguage,_that.pinnedWorks,_that.createdAt,_that.lastLogin,_that.readingProgress,_that.fcmTokens,_that.notificationSettings,_that.authorPoints,_that.authorRank,_that.readerPoints,_that.readerRank,_that.booksReadCount,_that.commentsPostedCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String username,  String email,  String? displayName,  String? photoURL,  String? coverPhotoURL,  String? bio,  String? penName,  String? instagramHandle,  String? privacyLevel,  bool? isDeactivated,  ProfileVisibility? profileVisibility,  int? followersCount,  int? followingCount,  List<dynamic> readingHistory,  List<dynamic> savedBooks,  List<Bookmark> bookmarks,  String? preferredLanguage,  List<String>? pinnedWorks,  int? createdAt,  int? lastLogin,  Map<String, dynamic>? readingProgress,  List<String>? fcmTokens,  NotificationSettings? notificationSettings,  int? authorPoints,  int? authorRank,  int? readerPoints,  int? readerRank,  int booksReadCount,  int commentsPostedCount)?  $default,) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.id,_that.username,_that.email,_that.displayName,_that.photoURL,_that.coverPhotoURL,_that.bio,_that.penName,_that.instagramHandle,_that.privacyLevel,_that.isDeactivated,_that.profileVisibility,_that.followersCount,_that.followingCount,_that.readingHistory,_that.savedBooks,_that.bookmarks,_that.preferredLanguage,_that.pinnedWorks,_that.createdAt,_that.lastLogin,_that.readingProgress,_that.fcmTokens,_that.notificationSettings,_that.authorPoints,_that.authorRank,_that.readerPoints,_that.readerRank,_that.booksReadCount,_that.commentsPostedCount);case _:
  return null;
...
class _UserModel implements UserModel {
  const _UserModel({required this.id, required this.username, required this.email, this.displayName, this.photoURL, this.coverPhotoURL, this.bio, this.penName, this.instagramHandle, this.privacyLevel, this.isDeactivated, this.profileVisibility, this.followersCount, this.followingCount, required final  List<dynamic> readingHistory, required final  List<dynamic> savedBooks, required final  List<Bookmark> bookmarks, this.preferredLanguage, final  List<String>? pinnedWorks, this.createdAt, this.lastLogin, final  Map<String, dynamic>? readingProgress, final  List<String>? fcmTokens, this.notificationSettings, this.authorPoints, this.authorRank, this.readerPoints, this.readerRank, this.booksReadCount = 0, this.commentsPostedCount = 0}): _readingHistory = readingHistory,_savedBooks = savedBooks,_bookmarks = bookmarks,_pinnedWorks = pinnedWorks,_readingProgress = readingProgress,_fcmTokens = fcmTokens;
...
@override final  int? authorPoints;
@override final  int? authorRank;
@override final  int? readerPoints;
@override final  int? readerRank;
@override@JsonKey() final  int booksReadCount;
@override@JsonKey() final  int commentsPostedCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,username,email,displayName,photoURL,coverPhotoURL,bio,penName,instagramHandle,privacyLevel,isDeactivated,profileVisibility,followersCount,followingCount,const DeepCollectionEquality().hash(_readingHistory),const DeepCollectionEquality().hash(_savedBooks),const DeepCollectionEquality().hash(_bookmarks),preferredLanguage,const DeepCollectionEquality().hash(_pinnedWorks),createdAt,lastLogin,const DeepCollectionEquality().hash(_readingProgress),const DeepCollectionEquality().hash(_fcmTokens),notificationSettings,authorPoints,authorRank,readerPoints,readerRank,booksReadCount,commentsPostedCount]);
...
/// Create a copy of UserModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? username = null,Object? email = null,Object? displayName = freezed,Object? photoURL = freezed,Object? coverPhotoURL = freezed,Object? bio = freezed,Object? penName = freezed,Object? instagramHandle = freezed,Object? privacyLevel = freezed,Object? isDeactivated = freezed,Object? profileVisibility = freezed,Object? followersCount = freezed,Object? followingCount = freezed,Object? readingHistory = null,Object? savedBooks = null,Object? bookmarks = null,Object? preferredLanguage = freezed,Object? pinnedWorks = freezed,Object? createdAt = freezed,Object? lastLogin = freezed,Object? readingProgress = freezed,Object? fcmTokens = freezed,Object? notificationSettings = freezed,Object? authorPoints = freezed,Object? authorRank = freezed,Object? readerPoints = freezed,Object? readerRank = freezed,Object? booksReadCount = null,Object? commentsPostedCount = null,}) {
