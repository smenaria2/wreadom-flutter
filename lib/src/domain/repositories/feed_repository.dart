...
abstract class FeedRepository {
  ...
  Future<List<FeedPost>> getFollowingFeed(List<String> followedUserIds, {int limit = 10, dynamic lastDoc});
  Future<List<FeedPost>> getUserFeedPosts(String userId, {int limit = 10, dynamic lastDoc});
